...
<div class="bg-gradient-to-br h-[65%] w-full from-purple-900 via-indigo-900 to-black py-10 ">
	<div class="relative  h-[100%] md:w-7xl mx-auto rounded-xl">
		...
		<div class="overflow-y-auto overscroll-contain backdrop-blur-xl h-[100%] bg-white/15 border border-white/30 rounded-xl z-10 p-5 mt-2 ">
			...
			<div class="shadow-2xl space-y-8 rounded-xl p-4 h-full w-full overflow-y-auto
            flex flex-col text-slate-300 font-semibold text-lg tracking-wider">
				...
				<div class="">
					...
					implementation it is listed in my:
					<a href="https://github.com/weironiottan/FindEDMShowsVegasReact" target="_blank" rel="noreferrer"
					   class="block transition duration-500 ease-in-out hover:text-slate-50 transform hover:-translate-y-1"
					>Github Repository</a>
				</div>
